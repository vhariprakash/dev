...
public class DefaultApi {
     ...
     */
    public com.squareup.okhttp.Call exampleGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call exampleGetValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = exampleGetCall(progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> exampleGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = exampleGetValidateBeforeCall(null, null);
     ...
     */
    public com.squareup.okhttp.Call exampleGetAsync(final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = exampleGetValidateBeforeCall(progressListener, progressRequestListener);
